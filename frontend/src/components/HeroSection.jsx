          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6  lg:px-8 pt-20 pb-16 relative z-10">
            <div className="text-center flex flex-col gap-5">
              <h1 className="text-4xl md:text-6xl xl:text-8xl font-bold text-white mb-6">
                <span className="block text-[#AD49BD]"> Knowledge Reimagined</span>
                AI That Thinks in Context, Delivers the Truth.
              </h1>
              <p className="sm:text-[12px] md:text-xl font-sans text-gray-400 max-w-2xl mx-auto mb-8">
                Step into the future of AI with our context-powered models, built to deliver unmatched precision and efficiency while solving hallucinations across diverse sectors.
              </p>
